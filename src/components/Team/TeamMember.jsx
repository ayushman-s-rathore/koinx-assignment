...
const TeamMember = () => {
  return (
    <div className="rounded-md bg-[#e8f4fd] px-3 py-2 flex items-center md:gap-8 flex-wrap md:flex-nowrap justify-center md:justify-start gap-4 sm:w-fit xs:w-[80vw]">
